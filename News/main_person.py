...
class Main:
    def __init__(self):
        self.select_sql = '''select `id`,
                ...
                `special_keyword`,
                `create_time`
         from {} where tag=0 and ((title_cn is not null and content_cn is not null) or srcl="zh") and publish_time is not null; '''.format(TABLE)
    ...
    def run(self):
        ...
        with open(file_path,'w',encoding= "utf-8")as f:
            ...
            for item in item_list:
                ...
                # 修改mysql 中的状态 生成更新的sql 语句。 然后 更新 tag字段作为标识。
                val= (id_)
