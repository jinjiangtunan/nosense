...
if MODE:
    settings = {
        ...
        # 2022-01-26 号 任务
        "NEW_STORE_PATH_PERSON":r"D:/{}/数据文件/NEWS/DSJ_ZYRWFX_NEWS.csv",
        # 2022-01-26 号 任务 
        "NEW_ZIP_PERSON":"{}.zip",
        "TABLE_NEWS": "news_data_translate",
        # 2022-01-26 号 任务
        "TABLE_PERSON":"dsj_zyrwfx_news_translate",
        "ARTICLE_FILENAME":"articleData.txt",
        "PACKAGE":"package",
        "ZIP_NAME":"dataInfo.zip",
        "ZIP_STORE":r"D:\ZIP_STORE",
        "API" : 'http://192.168.52.3/translate',
        "TIME_TRANSFER_API":"http://192.168.244.192:8000/api/format", # ----------------------
    }
else:
    settings = {
        "MYSQL": {
